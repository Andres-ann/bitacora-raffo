					...
					<div className='card m-3 p-3'>
						<div className='row mt-2'>
							<div className='col-3 col-sm-1'>
								<img
									src='https://i.ibb.co/Jzk8Smt/raffo-logo.jpg'
							...
							<div className='col-6 col-sm-8 ms-sm-4 me-3 me-sm-4 pt-1'>
								<p className='fw-bolder'>
									...
									<br />
									<span className='fw-lighter fst-italic text-muted'>@bitacora_Raffo</span>
								</p>
							</div>
							...
							<form className='ps-4' onSubmit={update}>
								...
								<div className='mb-1 mt-3'>
									<small className='text-muted'>
										{today} <span className='text-primary'>Twitter for Raffo</span>
									</small>
								</div>
								<hr />
